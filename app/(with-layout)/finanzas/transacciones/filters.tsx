...
import { DropdownActionCuentas } from "@/components/functionals/DropdownActionsCuentas";
...
export function FiltersTransacciones({
  ...
  return (
    <div className="md:flex md:justify-between md:items-center gap-2 space-y-2 md:space-y-0 mb-2">
      <div className="md:flex md:gap-2 max-md:space-y-2">
      ...
      <DropdownActionCuentas
        cuentas={(table.options.meta as TransaccionesTableMeta)?.cuentas}
      />
    </div>
  );
}
